...
class Move {
    ...
    static Move move(Move move0, Move move1) {
        ...
        if (move0.jumpTail() == null) {
            ...
            return move(move(move0._col0, move0.row0(),
                    move0._col1, move0._row1), move(move0.jumpTail(), move1));
        }
    ...
    boolean isDiagonalMove() {
        return this.row0() != this.row1() && this.col1() != this.col0();
    }
    ...
    private void toString(Formatter out) {
        if (jumpTail() == null) {
            ...
            out.format("%1$c%2$c-%3$s", col0(), row0(), jumpTail().toString());
        }
    }
